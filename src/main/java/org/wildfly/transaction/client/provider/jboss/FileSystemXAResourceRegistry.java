    ...
    private final class XAResourceRegistryFile extends XAResourceRegistry {
        ...
        protected void addResource(XAResource resource, Xid xid, URI uri) throws SystemException {
            ...
            try {
                ...
                fileChannel.write(ByteBuffer.wrap((SimpleXid.of(xid).toHexString() + System.lineSeparator()).getBytes(StandardCharsets.UTF_8)));
        ...
        private void loadInDoubtResources(String nodeName) throws IOException {
            ...
            while(linesIterator.hasNext()) {
                ...
                if (line.isEmpty()) line = linesIterator.next(); // TODO: what if there is no line?
                final Xid xid;
                xid = SimpleXid.of(line); // TODO: illegal state exception
