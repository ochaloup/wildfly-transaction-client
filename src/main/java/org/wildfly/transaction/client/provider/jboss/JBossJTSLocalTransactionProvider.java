...
final class JBossJTSLocalTransactionProvider extends JBossLocalTransactionProvider {
    ...
    JBossJTSLocalTransactionProvider(final int staleTransactionTime, final ExtendedJBossXATerminator ext, final TransactionManager tm, final JBossXATerminator jbossXATerminator) {
        super(ext, staleTransactionTime, tm, jbossXATerminator);
    }
